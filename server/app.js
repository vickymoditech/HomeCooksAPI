...
let privateKey = fs.readFileSync('/etc/letsencrypt/live/liveorder.thevelocitee.com/privkey.pem').toString();
let certificate = fs.readFileSync('/etc/letsencrypt/live/liveorder.thevelocitee.com/fullchain.pem').toString();
let credentials = {
